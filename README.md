...
| 💸 Transfer | Antar pengguna Student Plan |
...
2. Buat project baru → Beri nama "Student Plan"
3. Buka **APIs & Services** → **Credentials**
4. Klik **Create Credentials** → **OAuth 2.0 Client ID**
5. Application type: **Android**
6. Package name: `com.example.student_plan` (sesuaikan di `android/app/build.gradle`)
7. SHA-1 fingerprint:
   ```bash
...
1. Buka file `.vscode/launch.json` (sudah disediakan di project):
   ...
   ```
2. Tekan **F5** untuk menjalankan (pilih **Student Plan (Debug)** dari dropdown)
...
4. Tap **Install**
5. Selesai! Buka aplikasi **Student Plan** 🎉
